...
player_size = (50, 50)
player = pygame.image.load('kyr3.png').convert_alpha()  # pygame.Surface((player_size))
# player.fill((COLOR_BLACK))
# player_rect = player.get_rect()
player_rect = pygame.Rect(WIDTH - 800, HEIGHT - 500, *player_size)
...
def create_bonus():
    bonus_size = (50, 50)
    bonus = pygame.image.load('kyr4.png')  # pygame.Surface(bonus_size)
